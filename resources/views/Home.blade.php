      ...
      <div class="card">
        <div class="card-body p-3">
          <div class="row">
            <div class="col-8">
              <div class="numbers">
                <p class="text-sm font-weight-bolder mb-0 text-capitalize font-weight-bold">
Admin                </p>
    ...
    <div class="col-lg-12 mb-lg-0 mb-4 mt-4 rounded ">
      <div class="card">
        <div class="card-body p-3">
          <div class="row">
            <div class="col-lg-7">
              <div class="d-flex flex-column h-100">
                <h5 class="font-weight-bolder text-justify">"Pendataan Kapal dalam Industri Perikanan"</h5>
                <p class="mb-5 text-justify ">
                   merujuk pada proses pengumpulan, pengorganisasian, dan penyimpanan informasi terkait kapal yang digunakan dalam kegiatan perikanan. Proses ini melibatkan pelacakan berbagai aspek kapal, termasuk informasi tentang pemilik, spesifikasi teknis, alat tangkap yang digunakan, dan mungkin juga informasi operasional seperti daerah penangkapan dan hasil tangkapan.
                </p>
