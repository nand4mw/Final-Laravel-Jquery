...
<div class="sidenav-header">
  ...
  >
    <img
      src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTsEVxVPmVltkC3NEdHPeon1TmPQGnHkclxMg&usqp=CAU"
      class="navbar-brand-img h-100"
      width="50" 
      alt="logo-kapal-tanker"
    />
    <span class="ms-1 font-weight-bold ">Pendataan Kapal</span>
  </a>
</div>
...
>
  <ul class="navbar-nav" >
    ...
    <li class="nav-item">
      <a class="nav-link {{ request()->routeIs('pemilik') ? 'active' : '' }}" href="{{ route('pemilik') }}">
        <div
          class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center"
        >
          <svg
    ...
    <li class="nav-item">
      <a class="nav-link {{ request()->routeIs('dpi') ? 'active' : '' }}" href="{{ route('dpi') }}">
        <div
          class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center"
        >
          <svg
        ...
        <span class="nav-link-text ms-1">Daerah Penangkapan</span>
      </a>
    </li>
    <li class="nav-item">
      <a class="nav-link {{ request()->routeIs('alattangkap') ? 'active' : '' }}" href="{{ route('alattangkap') }}">
        <div
          class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center"
        >
          <svg
        ...
        <span class="nav-link-text ms-1">Alat Tangkap</span>
      </a>
    </li>
    <li class="nav-item">
      <a class="nav-link {{ request()->routeIs('kapal') ? 'active' : '' }}" href="{{ route('kapal') }}">
        <div
          class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center"
        >
          <svg
        ...
        <span class="nav-link-text ms-1">Verifikasi Kapal</span>
      </a>
    </li>
